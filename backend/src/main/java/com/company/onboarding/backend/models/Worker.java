...
public class Worker {
    ...
    private String teamAssigned; // The department that the worker is assigned to
    ...
    /**
     * Get the department assigned to the worker
     * @return teamAssigned
     */
    ...
    /**
     * Set the department assigned to the worker
     * @param teamAssigned The department to assign
     */
